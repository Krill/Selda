...
public class QuestPanel extends JPanel implements Observer{
	 ...
	 * Constructor
	 */
	public QuestPanel(PlayerCharacter player){
		this.player = player;
	...
	public void paintComponent(Graphics g) {
		Image img = new ImageIcon("images/gui/quests.png").getImage();	
